# Contributing to explica

Thanks for your interest in improving `explica`. This document explains how to propose changes, what the project's design constraints are, and how the maintainers review contributions.
...
- **Template improvements** — visual refinements that stay within the no-JS / no-external-resources rule.
